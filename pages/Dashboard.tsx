...
const Dashboard: React.FC = () => {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div>
        <h1 className="text-2xl font-bold text-slate-800">Ana Panel</h1>
        <p className="text-slate-500">Hoş geldiniz, bugünün tarımsal özet durumu.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm border border-slate-100 hover:shadow-md transition-shadow">
          <div className="flex justify-between items-start">
            <div>
              <p className="text-slate-500 text-sm font-medium">Tahmini Verim</p>
              <h3 className="text-2xl font-bold text-emerald-600 mt-1">1.250 kg/da</h3>
              <p className="text-emerald-600 text-xs mt-1 flex items-center gap-1 bg-emerald-50 w-fit px-2 py-0.5 rounded-full">
                <TrendingUp size={12} />
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm border border-slate-100 hover:shadow-md transition-shadow">
          <div className="flex justify-between items-start">
            <div>
              <p className="text-slate-500 text-sm font-medium">Risk Durumu</p>
              <h3 className="text-2xl font-bold text-amber-500 mt-1">Orta Risk</h3>
              <p className="text-slate-400 text-xs mt-1">Arz fazlası ihtimali</p>
            </div>
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm border border-slate-100 hover:shadow-md transition-shadow">
          <div className="flex justify-between items-start">
            <div>
              <p className="text-slate-500 text-sm font-medium">Son Güncelleme</p>
              <h3 className="text-2xl font-bold text-slate-800 mt-1">10:45</h3>
              <p className="text-slate-400 text-xs mt-1">Veriler senkronize</p>
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-white p-6 rounded-xl shadow-sm border border-slate-100">
          <div className="flex justify-between items-center mb-6">
            <h3 className="font-semibold text-slate-800">Sezonluk Verim Trendi</h3>
            <select className="text-sm border rounded-md px-2 py-1 text-slate-600">
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-100">
          <h3 className="font-semibold text-slate-800 mb-4">Son Gelişmeler</h3>
          <div className="space-y-4">
            {RECENT_UPDATES.map((update) => (
              <div key={update.id} className="flex gap-3 items-start pb-3 border-b border-slate-50 last:border-0">
                <div className={`w-2 h-2 mt-2 rounded-full shrink-0 ${
                  update.type === 'climate' ? 'bg-blue-500' : 
          ...
          <button className="w-full mt-4 text-sm text-emerald-600 font-medium hover:bg-emerald-50 py-2 rounded-lg transition-colors">
            Tümünü Gör
          </button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <button className="p-4 bg-white border border-emerald-100 rounded-xl flex items-center gap-4 hover:border-emerald-500 transition-colors group">
          ...
          <div className="text-left">
            <h4 className="font-semibold text-slate-800">Ekim Planla</h4>
            <p className="text-xs text-slate-500">Yeni sezon için analiz yap</p>
          </div>
        </button>
      </div>
    </div>
